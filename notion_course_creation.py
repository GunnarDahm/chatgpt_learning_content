...
# Set the ID of your course database and the template in Notion
course_database_id = ""
#template_id = "your_template_id"

def get_summary(master_topic, topic):
    prompt = f'''Please provide a brief summary of roughly 200 to 300 words of the following topic: {topic} as it relates to {master_topic}. Please ensure the summary of the topic is one singular paragraph. Please ensure the summary is strictly less than 2,000 characters. Additionally, please respond using the following format:  
